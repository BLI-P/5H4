...
import donaLogo from "@assets/welcome-icons/index.svg";
import macCommand from "@assets/welcome-icons/index.svg";
import donaLists from "@assets/welcome-icons/index.svg";
...
function Welcome() {
  ...
  const handleData = (): WelcomeProps => {
    switch (activeWelcomePage) {
      case 1:
        return {
          title: "5HADOW Todo List",
          subtitle: "This is the dark todo list application.",
          image: donaLogo,
        };
      case 2:
        return {
          title: "Hackable Todo",
          subtitle: "Hacking daily task with Todo.",
          image: donaLists,
        };
      case 3:
        return {
          title: "Hackable as App",
          subtitle: "Hacking daily task with Todo as native Application.",
          image: macCommand,
        };
      case 4:
        return {
          title: "What's your Alias ?",
          subtitle: "",
          image: "",
        };
      default:
